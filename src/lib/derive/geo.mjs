...
export const METRO_GROUPS = [
  ...
  { id: 'la', label: 'Los Angeles', country: 'us', region: 'CA', cities: [
    ...
    'playa vista', 'beverly hills', 'greater los angeles' ] },
  ...
  { id: 'boston', label: 'Boston', country: 'us', region: 'MA', cities: [
    ...
    'quincy', 'lexington, ma', 'watertown', 'greater boston' ] },
  { id: 'dc', label: 'Washington, D.C.', country: 'us', region: 'DC', cities: [
    ...
    'tysons', 'silver spring', 'chevy chase', 'crystal city', 'dmv' ] },
  { id: 'chicago', label: 'Chicago', country: 'us', region: 'IL', cities: [
    'chicago', 'evanston', 'oak brook', 'schaumburg', 'naperville', 'greater chicago' ] },
  ...
  { id: 'dallas', label: 'Dallas–Fort Worth', country: 'us', region: 'TX', cities: [
    ...
    'addison', 'dfw' ] },
  { id: 'houston', label: 'Houston', country: 'us', region: 'TX', cities: ['houston', 'the woodlands', 'sugar land'] },
  ...
  { id: 'san-diego', label: 'San Diego', country: 'us', region: 'CA', cities: ['san diego', 'la jolla', 'carlsbad', 'del mar'] },
  ...
  { id: 'raleigh-durham', label: 'Raleigh–Durham', country: 'us', region: 'NC', cities: ['raleigh', 'durham', 'chapel hill', 'cary', 'research triangle', 'rtp'] },
  ...
  { id: 'vancouver', label: 'Vancouver', country: 'ca', region: 'BC', cities: ['vancouver', 'burnaby', 'richmond, bc', 'surrey'] },
